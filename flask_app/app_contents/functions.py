...
def db_setup():
    ...
    db_submit('income_schema')
    db_submit('account_schema')
    db_submit('account_type_schema')
    db_submit('account_type_entry1')
    db_submit('account_type_entry2')
    db_submit('account_type_entry3')
    db_submit('account_type_entry4')
    db_submit('income_type_schema')
    db_submit('income_type_entry1')
    db_submit('income_type_entry2')
    db_submit('income_type_entry3')
    db_submit('expense_type_schema')
    db_submit('expense_type_entry1')
    db_submit('expense_type_entry2')
    db_submit('expense_type_entry3')
    db_submit('expense_type_entry4')
    db_submit('expense_type_entry5')
    db_submit('recurring_expenses_schema')
    db_submit('tax_status_schema')
    db_submit('tax_status_entry1')
    db_submit('tax_status_entry2')
    db_submit('tax_status_entry3')
